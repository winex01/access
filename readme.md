...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'winex01.access::fields',
]);
```
...
cp -i vendor/winex01/access/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
